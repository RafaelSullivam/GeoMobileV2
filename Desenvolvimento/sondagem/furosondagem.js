...
export default function FuroSondagem({ route, navigation },props) {
    ...
    function rota(furo) {
        ...
        navigation.navigate('NovoBoletimCadastroSondagem',{ nprocesso: furo });
      }
      function rota2(furo) { 
        navigation.navigate('',{ nprocesso: furo });
      }
            ...
            <View style={styles.container}>
                ...
                <View style={styles.containerrow}>
                    <TouchableOpacity style={styles.button}
                        onPress={() => navigation.navigate('CadastroFuroSondagem')}>
