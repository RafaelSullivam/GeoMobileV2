...
export default function AtividadeSondagem(props) {
    ...
    const gerarBancoSQlite = () => {
        db.transaction(
            (tx) => {
                tx.executeSql(
                    "create table if not exists AtividadeSondagem (IdAtividade text, Categoria text);"
                );
    ...
    const SalvarBancoSQLite = () => {
        ...
        db.transaction(
            (tx) => {
                tx.executeSql(`insert into AtividadeSondagem ( IdAtividade , Categoria) values ('${idatividade}','${categoria}' )`, (er) => { console.log(er) }, (error) => { console.log(error) });
                console.log('ok')
            },
    ...
    let DeleteBancoSQlite = () => {
        db.transaction((tx) => {
            tx.executeSql(
                'DELETE FROM  AtividadeSondagem where IdAtividade =?',
                [idatividade],
                (tx, results) => {
