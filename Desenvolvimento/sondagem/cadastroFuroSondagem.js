...
export default function CadastroFuroSondagem({ route, navigation },props) {
    ...
    const SalvarBancoSQLite = () => {
        ...
        db.transaction(
            (tx) => {
                tx.executeSql(`insert into BoletimSondagem ( IdFuro, AZ, DIP, Tipo , StatusBoletim) values ('${idfuro}','${az}','${dip}','${tipo}', '${'Aberto'}')`, (er) => { console.log(er) }, (error) => { console.log(error) });
